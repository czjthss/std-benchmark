...
if __name__ == '__main__':
    ...
    y = []
    f = open("/Users/chenzijie/Documents/GitHub/std-benchmark/src/main/java/algorithm/FastRobustSTL/input.txt", "r")
    ...
    season_regs = [[1],    # reg 1, 2, 3 for seasonality  1
                   [100],   # reg 1, 2, 3 for seasonality  2
                   [0.01]]  # reg 1, 2, 3 for seasonality  3
    ...
    input_ori, trend, seasonal, residual = result

    f = open("/Users/chenzijie/Documents/GitHub/std-benchmark/src/main/java/algorithm/FastRobustSTL/trend.txt", "w")
    f.write("\n".join([str(item) for item in trend]))
    f.close()

    f = open("/Users/chenzijie/Documents/GitHub/std-benchmark/src/main/java/algorithm/FastRobustSTL/seasonal.txt", "w")
    f.write("\n".join([str(item) for item in seasonal]))
    f.close()

    f = open("/Users/chenzijie/Documents/GitHub/std-benchmark/src/main/java/algorithm/FastRobustSTL/residual.txt", "w")
